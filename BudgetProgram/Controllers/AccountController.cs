...
namespace BudgetProgram.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ChangeUserName(ChangeNameViewModel model)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("JoinCreateHouseHold", "HouseHolds");
                    }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> DemoLogin(string email, string password)
        {
